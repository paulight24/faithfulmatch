import { PrismaClient, Gender, FaithLevel, ChurchInvolvement, MarriageIntent, PhotoModerationStatus, ProfileVisibilityStatus, UserStatus } from '@prisma/client';
...
const SEED_PROFILES: SeedProfile[] = [
  {
    ...
    faithLevel: FaithLevel.VERY_ACTIVE,
    churchInvolvement: ChurchInvolvement.WEEKLY,
    marriageIntent: MarriageIntent.WITHIN_ONE_YEAR,
  ...
  },
  {
    ...
    faithLevel: FaithLevel.VERY_ACTIVE,
    churchInvolvement: ChurchInvolvement.WEEKLY,
    marriageIntent: MarriageIntent.READY_NOW,
  ...
  },
  {
    ...
    faithLevel: FaithLevel.ACTIVE,
    churchInvolvement: ChurchInvolvement.REGULARLY,
    marriageIntent: MarriageIntent.WITHIN_ONE_YEAR,
  ...
  },
  {
    ...
    churchInvolvement: ChurchInvolvement.OCCASIONALLY,
    marriageIntent: MarriageIntent.WITHIN_THREE_YEARS,
  ...
  for (const sp of SEED_PROFILES) {
    ...
    await prisma.profile.create({
      data: {
        ...
        visibilityStatus: ProfileVisibilityStatus.VISIBLE,
      },
    });
    ...
    await prisma.preference.create({
      data: {
        userId: user.id,
        genderPreference: sp.gender === Gender.MALE ? Gender.FEMALE : Gender.MALE,
