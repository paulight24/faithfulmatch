...
const rsvp_event_dto_1 = require("./dto/rsvp-event.dto");
let EventsController = class EventsController {
    ...
    getMyEvents(user) {
        return this.events.getMyEvents(user.id);
    }
    getById(user, id) {
        return this.events.getById(user.id, id);
    }
    create(user, dto) {
    ...
    rsvp(user, id, dto) {
        return this.events.rsvp(user.id, id, dto);
    }
    cancelRsvp(user, id) {
        return this.events.cancelRsvp(user.id, id);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, rsvp_event_dto_1.RsvpEventDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], EventsController.prototype, "cancelRsvp", null);
